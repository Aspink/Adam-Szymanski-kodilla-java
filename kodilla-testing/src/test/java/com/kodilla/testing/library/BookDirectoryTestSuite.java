...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfReturnList() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Robert Roy", "McGregor","45120342567");
        List<Book> resultListOf7Books = generateListOfNBooks(7);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser))
                .thenReturn(resultListOf7Books);

        // When
        List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(libraryUser);

        // Then
        assertEquals(7, theListOfBooks.size());
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser0 = new LibraryUser("Robert Roy", "McGregor","45120342567");
        LibraryUser libraryUser1 = new LibraryUser("Wilhelm", "Tell","55102034256");
        LibraryUser libraryUser5 = new LibraryUser("William", "Wallace","54010203425");
        List<Book> resultListOf0Books = new ArrayList<Book>();
